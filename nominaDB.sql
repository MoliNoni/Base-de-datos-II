...
CREATE TABLE Nomina (
    ...
    TotalDevengado DECIMAL(10,2) NOT NULL DEFAULT 0,
    TotalDeducciones DECIMAL(10,2) NOT NULL DEFAULT 0,
    NetoPagar AS (TotalDevengado - TotalDeducciones) PERSISTED,
...
INSERT INTO Nomina (IdEmpleado, FechaInicio, FechaFin, TotalDevengado, TotalDeducciones) VALUES
(1, '2024-01-01', '2024-01-15', 1750.00, 200.00),
(2, '2024-01-01', '2024-01-15', 1500.00, 180.00),
(3, '2024-01-01', '2024-01-15', 1400.00, 150.00),
(4, '2024-01-01', '2024-01-15', 1300.00, 120.00);
GO
...
SELECT * FROM Empleado WHERE IdTipoContrato = 1;

SELECT * FROM Cargo WHERE SalarioBase > 3000;
